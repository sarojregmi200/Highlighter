...
export default function ActiveCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPen(initialValues.pen);
    setBackground(initialValues.background);
    setUnderline(initialValues.underline);
    setErrors({});
  };
  const validations = {
    topic: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Active(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ActiveCreateForm")}
      {...rest}
    >
      <TextField
        label="Topic"
