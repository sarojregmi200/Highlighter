...
export interface IIndex<I extends OpaqueIndex = OpaqueIndex> {
    create<S extends Schema, D extends OpaqueDocumentStore, So extends OpaqueSorter>(orama: Orama<{
        ...
        DocumentStore: D;
        Sorter: So;
    }>, sharedInternalDocumentStore: InternalDocumentIDStore, schema: Schema): SyncOrAsyncValue<I>;
    beforeInsert?: IIndexInsertOrRemoveHookFunction<I>;
    insert: (implementation: IIndex<I>, index: I, prop: string, id: DocumentID, value: SearchableValue, schemaType: SearchableType, language: string | undefined, tokenizer: Tokenizer, docsCount: number) => SyncOrAsyncValue;
    afterInsert?: IIndexInsertOrRemoveHookFunction<I>;
    beforeRemove?: IIndexInsertOrRemoveHookFunction<I>;
    remove: (implementation: IIndex<I>, index: I, prop: string, id: DocumentID, value: SearchableValue, schemaType: SearchableType, language: string | undefined, tokenizer: Tokenizer, docsCount: number) => SyncOrAsyncValue<boolean>;
    ...
    calculateResultScores<D extends OpaqueDocumentStore, AggValue = Result[]>(context: SearchContext<I, D, AggValue>, index: I, prop: string, term: string, ids: DocumentID[]): SyncOrAsyncValue<TokenScore[]>;
    ...
    searchByWhereClause<D extends OpaqueDocumentStore, AggValue = Result[]>(context: SearchContext<I, D, AggValue>, index: I, filters: Record<string, boolean | string | string[] | ComparisonOperator>): SyncOrAsyncValue<InternalDocumentID[]>;
...
export interface IDocumentsStore<D extends OpaqueDocumentStore = OpaqueDocumentStore> {
    create<S extends Schema, I extends OpaqueIndex, So extends OpaqueSorter>(orama: Orama<{
        ...
        DocumentStore: D;
        Sorter: So;
    }>, sharedInternalDocumentStore: InternalDocumentIDStore): SyncOrAsyncValue<D>;
...
export interface ISorter<So extends OpaqueSorter = OpaqueSorter> {
    create<S extends Schema, I extends OpaqueIndex, D extends OpaqueDocumentStore>(orama: Orama<{
        ...
        DocumentStore: D;
        Sorter: So;
    }>, sharedInternalDocumentStore: InternalDocumentIDStore, schema: Schema, sorterConfig?: SorterConfig): SyncOrAsyncValue<So>;
    insert: (sorter: So, prop: string, id: DocumentID, value: SortValue, schemaType: SortType, language: string | undefined) => SyncOrAsyncValue;
